 ...
 */
package sk.ab.herbs.billingmodule.billing;
...
public final class BillingConstants {
    ...
    public static final String SKU_MONTHLY = "1_month_subscription";
    public static final String SKU_YEARLY = "1_year_subscription";
