...
public class RESTService extends IntentService {
        ...
        try {
            ...
            switch (verb) {
                ...
                case POST: {
                    ...
                    if (params != null) {
                        StringEntity stringEntity = new StringEntity(getJSONBody(params));
            ...
            if (request != null) {
                ...
                if (responseEntity != null) {
                    ...
                    resultData.putString(REST_RESULT, EntityUtils.toString(responseEntity, "UTF-8"));
    ...
    private static String getJSONBody(Bundle params) {
        String body = "{}";
